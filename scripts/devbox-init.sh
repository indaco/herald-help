#!/usr/bin/env bash
# devbox-init.sh - Development environment setup for herald help
...
h1 "herald-help - Development Environment Setup"
...
if command_exists go; then
    ...
    install_go_tool "sley" "github.com/indac0/sley@latest"
...
log_faint ""
log_faint "  Cross-module commands (root + cobra, urfave, kong):"
log_faint "  just test-all          - Run tests across all sub-modules"
log_faint "  just test-force-all    - Clean test cache and run all tests across all sub-modules"
log_faint "  just test-race-all     - Run tests with race detector across all sub-modules"
log_faint "  just lint-all          - Run lint across all sub-modules"
log_faint "  just fmt-all           - Run fmt across all sub-modules"
log_faint "  just tidy-all          - Run tidy across all sub-modules"
log_faint "  just check-all         - Run full check across root + all sub-modules"
log_faint ""
log_faint "  Module management:"
...
log_faint ""
log_faint "  Demo screenshots:"
log_faint "  just demo-screenshot   - Generate all demo screenshots + hero collage"
log_default ""
log_faint "Quick start: just check-all to run all quality checks across all modules!"
log_default ""
