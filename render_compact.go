...
// compactFlagList renders a slice of flags as an indented KV list with
// colored flag names, faint types/defaults, and highlighted env vars.
// Flag names and types are independently padded for clean column alignment.
func compactFlagList(ty *herald.Typography, flags []Flag, cfg *RenderConfig) string {
	...
	return ty.KVGroupWithOpts(pairs, compactKVOpts()...)
}
...
// with colored command names. Name and alias columns are independently aligned.
