...
// Run:
//
//	go run ./examples/rich/000_manual/ greet --name Alice
//	go run ./examples/rich/000_manual/ --help
package main
...
func main() {
	...
	if len(args) == 0 || args[0] == "--help" || args[0] == "-h" {
		fmt.Println(heraldhelp.Render(ty, cmd, heraldhelp.WithStyle(heraldhelp.StyleRich)))
		return
	}
