// A real urfave/cli app with a "greet" command and compact-style themed help via herald.
// Run:
//
//	cd examples/compact/003_urfave && go run . greet --name Alice
//	cd examples/compact/003_urfave && go run . --help
//	cd examples/compact/003_urfave && go run . greet --help
package main
...
func main() {
	...
	// Override the global help printer with herald compact-style output.
