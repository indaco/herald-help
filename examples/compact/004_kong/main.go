// A real kong CLI with a "greet" command and compact-style themed help via herald.
// Run:
//
//	cd examples/compact/004_kong && go run . greet --name Alice
//	cd examples/compact/004_kong && go run . --help
package main
...
func main() {
	...
	parser, err := kong.New(&cli,
		...
		kong.Help(func(_ kong.HelpOptions, ctx *kong.Context) error {
			...
			return heraldhelp.RenderTo(os.Stdout, ty, hc)
		}),
	)
	if err != nil {
